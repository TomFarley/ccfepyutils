...
class Ellipses(object):
    ...
    def plot(self, ax=None, show=False, equal_aspect=False, deg=True, color='k', half_widths=False, **kwargs):
        ...
        plot_ellipses(ax, major, minor, angle, x=x, y=y, color=color, half_widths=half_widths, **kwargs)
        if show:
            plt.show()
